...
#######Since you aren't using an initial split, use the following to create to do the fit to the full data and save predicted values
final_polyreg %>% augment() 
  fit(Wage) %>% 
  predict(Wage) %>% 
...
####use unnest and group by model_text and use summarise to calculate the MSE.
